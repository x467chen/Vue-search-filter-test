...
export default {
    ...
    data: function() {
        return {
            myData:[],
            dbData:[{value: 'p1',index: 1},{value: 'p2',index: 2},{value: 'p3',index: 3},{value: 'p11',index: 4}],
    ...
    methods: {
        ...
        get: function(ev) {
            ...
            if(keyword!=undefined){
              this.myData=this.dbData.filter(function (data) {
                                   return data.value.toLowerCase().indexOf(keyword.toLowerCase()) > -1;
                                 })
                                 };
        ...
        selectClick: function(index) {
            this.keyword = this.myData[index].value;
            this.myData=[];
        },
        clearInput: function() {
            this.keyword = '';
